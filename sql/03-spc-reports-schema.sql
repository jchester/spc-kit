...
-- * `id_instrument`. The instrument ID. Use this carefully as calculations can be incorrect if there are more than one
--    control window per instrument.
-- * `data_center_line`. The center line of the Shewhart chart. In this case it is the grand mean of fraction
--   conforming.
-- * `data_controlled_value`. The value under control. In this case it is the sample mean fraction conforming.
-- * `data_upper_limit`. The upper control limit for the control window, based on the limit establishment window. Is
...
create view spc_reports.p_conformant_rules as
  select ss.sample_id                                                                       as id_sample
       ...
       , i.id                                                                               as id_instrument
       , center_line                                                                        as data_center_line
       , mean_fraction_conforming                                                           as data_controlled_value
       , upper_limit                                                                        as data_upper_limit
       , lower_limit                                                                        as data_lower_limit
       , mean_fraction_conforming < upper_limit and mean_fraction_conforming > lower_limit  as rule_in_control
       , mean_fraction_conforming > upper_limit                                             as rule_out_of_control_upper
       , mean_fraction_conforming < lower_limit                                             as rule_out_of_control_lower
...
-- * `data_center_line`. The center line of the Shewhart chart. In this case it is the grand mean of fraction
--   non-conforming.
-- * `data_controlled_value`. The value under control. In this case it is the sample mean fraction non-conforming.
-- * `data_upper_limit`. The upper control limit for the control window, based on the limit establishment window. Is
--   identical for every row.
-- * `data_lower_limit`. The lower control limit for the control window, based on the limit establishment window. Is
--   identical for every row.
